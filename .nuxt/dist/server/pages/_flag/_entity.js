...
/* harmony default export */ var _entityvue_type_script_lang_js_ = ({
  ...
  computed: {
    flat_entities() {
      let entities = [...this.related, ...(this.entity ? [this.entity] : [])];
