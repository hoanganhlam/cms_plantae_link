...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/Entity.vue?vue&type=template&id=7ef5a7ea&scoped=true&
...
// CONCATENATED MODULE: ./components/Entity.vue?vue&type=template&id=7ef5a7ea&scoped=true&
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/_flag/_entity.vue?vue&type=template&id=3f8abe08&
...
// CONCATENATED MODULE: ./pages/_flag/_entity.vue?vue&type=template&id=3f8abe08&
...
/* harmony default export */ var _entityvue_type_script_lang_js_ = ({
  ...
  computed: {
    flat_entities() {
      let entities = [...this.related.filter(x => this.schemas.includes(x.taxonomy)), ...(this.entity ? [this.entity] : [])];
      entities.forEach(e => e.order = this.schemas.indexOf(e.taxonomy));
      entities = entities.filter((thing, index, self) => index === self.findIndex(t => t.id === thing.id));
